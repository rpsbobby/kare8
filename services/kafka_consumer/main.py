...
if __name__ == "__main__":
    ...
    message_handler = MessageHandler(kafka_producer=kafka_producer, worker=worker, model_cls=Order, topic_in=TOPIC_IN, dlq_topic=DLQ_TOPIC,
                                     park_topic=PARK_TOPIC, logger=logger, max_attempts=MAX_ATTEMPTS)
